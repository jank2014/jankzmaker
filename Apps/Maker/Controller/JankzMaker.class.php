...
class JankzMaker extends Controller{
	 ...
	 * @var [type]
	 */
	private $conftpl = array();			//页面布局 参数 type 生成类型 form table sort picture
	...
	protected function _initialize(){
		$this->template = APP_PATH.'Maker/View/jankzmaker.html';
	}
	/**
	 * [设置页面布局]
...
//表格生成
	...
	public function display(){
		switch ($this->conftpl['type']) {//根据后台设置类型 使用具体变量和模板类型输出
			case 'newform':
